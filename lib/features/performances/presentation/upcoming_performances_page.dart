...
class UpcomingPerformancesPage extends StatelessWidget {
  const UpcomingPerformancesPage({super.key});
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Upcoming Performances', style: AppTheme.theme.textTheme.headlineLarge?.copyWith(color: AppTheme.primaryOrange)),
              const SizedBox(height: 16),
              Expanded(
                child: StreamBuilder<List<PerformanceRequest>>(
                  stream: repo.streamUpcomingComplete(),
                  builder: (context, snapshot) {
                    ...
                    if (items.isEmpty) {
                      return const Center(child: Text('No upcoming performances yet.', style: TextStyle(color: AppTheme.lightGray)));
                    }
